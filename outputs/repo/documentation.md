...
{ 'children': [ { 'name': '.coveragerc',
                  'path': '/tmp/tmpkl_8b4xv/repo/.coveragerc',
                  'type': 'file'},
                { 'name': '.git',
                  'path': '/tmp/tmpkl_8b4xv/repo/.git',
                  'type': 'dir'},
                { 'name': '.git-blame-ignore-revs',
                  'path': '/tmp/tmpkl_8b4xv/repo/.git-blame-ignore-revs',
                  'type': 'file'},
                { 'children': [ { 'name': 'CODE_OF_CONDUCT.md',
                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/CODE_OF_CONDUCT.md',
                                  'type': 'file'},
                                { 'name': 'CONTRIBUTING.md',
                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/CONTRIBUTING.md',
                                  'type': 'file'},
                                { 'name': 'FUNDING.yml',
                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/FUNDING.yml',
                                  'type': 'file'},
                                { 'children': [ { 'name': 'Bug_report.md',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/ISSUE_TEMPLATE/Bug_report.md',
                                                  'type': 'file'},
                                                { 'name': 'Custom.md',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/ISSUE_TEMPLATE/Custom.md',
                                                  'type': 'file'},
                                                { 'name': 'Feature_request.md',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/ISSUE_TEMPLATE/Feature_request.md',
                                                  'type': 'file'}],
                                  'name': 'ISSUE_TEMPLATE',
                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/ISSUE_TEMPLATE',
                                  'type': 'dir'},
                                { 'name': 'ISSUE_TEMPLATE.md',
                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/ISSUE_TEMPLATE.md',
                                  'type': 'file'},
                                { 'name': 'SECURITY.md',
                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/SECURITY.md',
                                  'type': 'file'},
                                { 'name': 'dependabot.yml',
                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/dependabot.yml',
                                  'type': 'file'},
                                { 'children': [ { 'name': 'close-issues.yml',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/workflows/close-issues.yml',
                                                  'type': 'file'},
                                                { 'name': 'codeql-analysis.yml',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/workflows/codeql-analysis.yml',
                                                  'type': 'file'},
                                                { 'name': 'lint.yml',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/workflows/lint.yml',
                                                  'type': 'file'},
                                                { 'name': 'lock-issues.yml',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/workflows/lock-issues.yml',
                                                  'type': 'file'},
                                                { 'name': 'publish.yml',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/workflows/publish.yml',
                                                  'type': 'file'},
                                                { 'name': 'run-tests.yml',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/workflows/run-tests.yml',
                                                  'type': 'file'}],
                                  'name': 'workflows',
                                  'path': '/tmp/tmpkl_8b4xv/repo/.github/workflows',
                                  'type': 'dir'}],
                  'name': '.github',
                  'path': '/tmp/tmpkl_8b4xv/repo/.github',
                  'type': 'dir'},
                { 'name': '.gitignore',
                  'path': '/tmp/tmpkl_8b4xv/repo/.gitignore',
                  'type': 'file'},
                { 'name': '.pre-commit-config.yaml',
                  'path': '/tmp/tmpkl_8b4xv/repo/.pre-commit-config.yaml',
                  'type': 'file'},
                { 'name': '.readthedocs.yaml',
                  'path': '/tmp/tmpkl_8b4xv/repo/.readthedocs.yaml',
                  'type': 'file'},
                { 'name': 'AUTHORS.rst',
                  'path': '/tmp/tmpkl_8b4xv/repo/AUTHORS.rst',
                  'type': 'file'},
                { 'name': 'HISTORY.md',
                  'path': '/tmp/tmpkl_8b4xv/repo/HISTORY.md',
                  'type': 'file'},
                { 'name': 'LICENSE',
                  'path': '/tmp/tmpkl_8b4xv/repo/LICENSE',
                  'type': 'file'},
                { 'name': 'MANIFEST.in',
                  'path': '/tmp/tmpkl_8b4xv/repo/MANIFEST.in',
                  'type': 'file'},
                { 'name': 'Makefile',
                  'path': '/tmp/tmpkl_8b4xv/repo/Makefile',
                  'type': 'file'},
                { 'name': 'NOTICE',
                  'path': '/tmp/tmpkl_8b4xv/repo/NOTICE',
                  'type': 'file'},
                { 'name': 'README.md',
                  'path': '/tmp/tmpkl_8b4xv/repo/README.md',
                  'type': 'file'},
                { 'children': [ { 'name': '.nojekyll',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/.nojekyll',
                                  'type': 'file'},
                                { 'name': 'Makefile',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/Makefile',
                                  'type': 'file'},
                                { 'children': [ { 'name': 'custom.css',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/_static/custom.css',
                                                  'type': 'file'},
                                                { 'name': 'requests-sidebar.png',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/_static/requests-sidebar.png',
                                                  'type': 'file'}],
                                  'name': '_static',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/_static',
                                  'type': 'dir'},
                                { 'children': [ { 'name': 'hacks.html',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/_templates/hacks.html',
                                                  'type': 'file'},
                                                { 'name': 'sidebarintro.html',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/_templates/sidebarintro.html',
                                                  'type': 'file'},
                                                { 'name': 'sidebarlogo.html',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/_templates/sidebarlogo.html',
                                                  'type': 'file'}],
                                  'name': '_templates',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/_templates',
                                  'type': 'dir'},
                                { 'children': [ { 'name': '.gitignore',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/_themes/.gitignore',
                                                  'type': 'file'},
                                                { 'name': 'LICENSE',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/_themes/LICENSE',
                                                  'type': 'file'},
                                                { 'name': 'flask_theme_support.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/_themes/flask_theme_support.py',
                                                  'type': 'file'}],
                                  'name': '_themes',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/_themes',
                                  'type': 'dir'},
                                { 'name': 'api.rst',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/api.rst',
                                  'type': 'file'},
                                { 'children': [ { 'name': 'faq.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/community/faq.rst',
                                                  'type': 'file'},
                                                { 'name': 'out-there.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/community/out-there.rst',
                                                  'type': 'file'},
                                                { 'name': 'recommended.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/community/recommended.rst',
                                                  'type': 'file'},
                                                { 'name': 'release-process.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/community/release-process.rst',
                                                  'type': 'file'},
                                                { 'name': 'support.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/community/support.rst',
                                                  'type': 'file'},
                                                { 'name': 'updates.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/community/updates.rst',
                                                  'type': 'file'},
                                                { 'name': 'vulnerabilities.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/community/vulnerabilities.rst',
                                                  'type': 'file'}],
                                  'name': 'community',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/community',
                                  'type': 'dir'},
                                { 'name': 'conf.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/conf.py',
                                  'type': 'file'},
                                { 'children': [ { 'name': 'authors.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/dev/authors.rst',
                                                  'type': 'file'},
                                                { 'name': 'contributing.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/dev/contributing.rst',
                                                  'type': 'file'}],
                                  'name': 'dev',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/dev',
                                  'type': 'dir'},
                                { 'name': 'index.rst',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/index.rst',
                                  'type': 'file'},
                                { 'name': 'make.bat',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/make.bat',
                                  'type': 'file'},
                                { 'name': 'requirements.txt',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/requirements.txt',
                                  'type': 'file'},
                                { 'children': [ { 'name': 'advanced.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/user/advanced.rst',
                                                  'type': 'file'},
                                                { 'name': 'authentication.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/user/authentication.rst',
                                                  'type': 'file'},
                                                { 'name': 'install.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/user/install.rst',
                                                  'type': 'file'},
                                                { 'name': 'quickstart.rst',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/user/quickstart.rst',
                                                  'type': 'file'}],
                                  'name': 'user',
                                  'path': '/tmp/tmpkl_8b4xv/repo/docs/user',
                                  'type': 'dir'}],
                  'name': 'docs',
                  'path': '/tmp/tmpkl_8b4xv/repo/docs',
                  'type': 'dir'},
                { 'children': [ { 'name': 'LICENSE',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/LICENSE',
                                  'type': 'file'},
                                { 'name': 'flower-of-life.jpg',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/flower-of-life.jpg',
                                  'type': 'file'},
                                { 'name': 'kr-compressed.png',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/kr-compressed.png',
                                  'type': 'file'},
                                { 'name': 'kr.png',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/kr.png',
                                  'type': 'file'},
                                { 'name': 'psf-compressed.png',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/psf-compressed.png',
                                  'type': 'file'},
                                { 'name': 'psf.png',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/psf.png',
                                  'type': 'file'},
                                { 'name': 'requests-logo-compressed.png',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/requests-logo-compressed.png',
                                  'type': 'file'},
                                { 'name': 'requests-logo.ai',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/requests-logo.ai',
                                  'type': 'file'},
                                { 'name': 'requests-logo.png',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/requests-logo.png',
                                  'type': 'file'},
                                { 'name': 'requests-logo.svg',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/requests-logo.svg',
                                  'type': 'file'},
                                { 'name': 'ss-compressed.png',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/ss-compressed.png',
                                  'type': 'file'},
                                { 'name': 'ss.png',
                                  'path': '/tmp/tmpkl_8b4xv/repo/ext/ss.png',
                                  'type': 'file'}],
                  'name': 'ext',
                  'path': '/tmp/tmpkl_8b4xv/repo/ext',
                  'type': 'dir'},
                { 'name': 'pyproject.toml',
                  'path': '/tmp/tmpkl_8b4xv/repo/pyproject.toml',
                  'type': 'file'},
                { 'name': 'requirements-dev.txt',
                  'path': '/tmp/tmpkl_8b4xv/repo/requirements-dev.txt',
                  'type': 'file'},
                { 'name': 'setup.cfg',
                  'path': '/tmp/tmpkl_8b4xv/repo/setup.cfg',
                  'type': 'file'},
                { 'name': 'setup.py',
                  'path': '/tmp/tmpkl_8b4xv/repo/setup.py',
                  'type': 'file'},
                { 'children': [ { 'children': [ { 'name': '__init__.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/__init__.py',
                                                  'type': 'file'},
                                                { 'name': '__version__.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/__version__.py',
                                                  'type': 'file'},
                                                { 'name': '_internal_utils.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/_internal_utils.py',
                                                  'type': 'file'},
                                                { 'name': 'adapters.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/adapters.py',
                                                  'type': 'file'},
                                                { 'name': 'api.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/api.py',
                                                  'type': 'file'},
                                                { 'name': 'auth.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/auth.py',
                                                  'type': 'file'},
                                                { 'name': 'certs.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/certs.py',
                                                  'type': 'file'},
                                                { 'name': 'compat.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/compat.py',
                                                  'type': 'file'},
                                                { 'name': 'cookies.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/cookies.py',
                                                  'type': 'file'},
                                                { 'name': 'exceptions.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/exceptions.py',
                                                  'type': 'file'},
                                                { 'name': 'help.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/help.py',
                                                  'type': 'file'},
                                                { 'name': 'hooks.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/hooks.py',
                                                  'type': 'file'},
                                                { 'name': 'models.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/models.py',
                                                  'type': 'file'},
                                                { 'name': 'packages.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/packages.py',
                                                  'type': 'file'},
                                                { 'name': 'sessions.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/sessions.py',
                                                  'type': 'file'},
                                                { 'name': 'status_codes.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/status_codes.py',
                                                  'type': 'file'},
                                                { 'name': 'structures.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/structures.py',
                                                  'type': 'file'},
                                                { 'name': 'utils.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests/utils.py',
                                                  'type': 'file'}],
                                  'name': 'requests',
                                  'path': '/tmp/tmpkl_8b4xv/repo/src/requests',
                                  'type': 'dir'}],
                  'name': 'src',
                  'path': '/tmp/tmpkl_8b4xv/repo/src',
                  'type': 'dir'},
                { 'children': [ { 'name': '__init__.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/__init__.py',
                                  'type': 'file'},
                                { 'children': [ { 'name': 'README.md',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/README.md',
                                                  'type': 'file'},
                                                { 'children': [ { 'name': 'Makefile',
                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/Makefile',
                                                                  'type': 'file'},
                                                                { 'name': 'README.md',
                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/README.md',
                                                                  'type': 'file'},
                                                                { 'children': [ { 'name': 'Makefile',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/ca/Makefile',
                                                                                  'type': 'file'},
                                                                                { 'name': 'ca-private.key',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/ca/ca-private.key',
                                                                                  'type': 'file'},
                                                                                { 'name': 'ca.cnf',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/ca/ca.cnf',
                                                                                  'type': 'file'},
                                                                                { 'name': 'ca.crt',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/ca/ca.crt',
                                                                                  'type': 'file'},
                                                                                { 'name': 'ca.srl',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/ca/ca.srl',
                                                                                  'type': 'file'}],
                                                                  'name': 'ca',
                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/ca',
                                                                  'type': 'dir'},
                                                                { 'children': [ { 'name': 'Makefile',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/server/Makefile',
                                                                                  'type': 'file'},
                                                                                { 'name': 'cert.cnf',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/server/cert.cnf',
                                                                                  'type': 'file'},
                                                                                { 'name': 'server.csr',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/server/server.csr',
                                                                                  'type': 'file'},
                                                                                { 'name': 'server.key',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/server/server.key',
                                                                                  'type': 'file'},
                                                                                { 'name': 'server.pem',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/server/server.pem',
                                                                                  'type': 'file'}],
                                                                  'name': 'server',
                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired/server',
                                                                  'type': 'dir'}],
                                                  'name': 'expired',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/expired',
                                                  'type': 'dir'},
                                                { 'children': [ { 'name': 'Makefile',
                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/Makefile',
                                                                  'type': 'file'},
                                                                { 'name': 'README.md',
                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/README.md',
                                                                  'type': 'file'},
                                                                { 'children': [ { 'name': 'Makefile',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client/Makefile',
                                                                                  'type': 'file'},
                                                                                { 'children': [ { 'name': 'Makefile',
                                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client/ca/Makefile',
                                                                                                  'type': 'file'},
                                                                                                { 'name': 'ca-private.key',
                                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client/ca/ca-private.key',
                                                                                                  'type': 'file'},
                                                                                                { 'name': 'ca.cnf',
                                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client/ca/ca.cnf',
                                                                                                  'type': 'file'},
                                                                                                { 'name': 'ca.crt',
                                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client/ca/ca.crt',
                                                                                                  'type': 'file'},
                                                                                                { 'name': 'ca.srl',
                                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client/ca/ca.srl',
                                                                                                  'type': 'file'}],
                                                                                  'name': 'ca',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client/ca',
                                                                                  'type': 'dir'},
                                                                                { 'name': 'cert.cnf',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client/cert.cnf',
                                                                                  'type': 'file'},
                                                                                { 'name': 'client.csr',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client/client.csr',
                                                                                  'type': 'file'},
                                                                                { 'name': 'client.key',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client/client.key',
                                                                                  'type': 'file'},
                                                                                { 'name': 'client.pem',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client/client.pem',
                                                                                  'type': 'file'}],
                                                                  'name': 'client',
                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls/client',
                                                                  'type': 'dir'}],
                                                  'name': 'mtls',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/mtls',
                                                  'type': 'dir'},
                                                { 'children': [ { 'children': [ { 'name': 'Makefile',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/ca/Makefile',
                                                                                  'type': 'file'},
                                                                                { 'name': 'ca-private.key',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/ca/ca-private.key',
                                                                                  'type': 'file'},
                                                                                { 'name': 'ca.cnf',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/ca/ca.cnf',
                                                                                  'type': 'file'},
                                                                                { 'name': 'ca.crt',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/ca/ca.crt',
                                                                                  'type': 'file'},
                                                                                { 'name': 'ca.srl',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/ca/ca.srl',
                                                                                  'type': 'file'}],
                                                                  'name': 'ca',
                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/ca',
                                                                  'type': 'dir'},
                                                                { 'children': [ { 'name': 'Makefile',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/server/Makefile',
                                                                                  'type': 'file'},
                                                                                { 'name': 'cert.cnf',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/server/cert.cnf',
                                                                                  'type': 'file'},
                                                                                { 'name': 'server.csr',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/server/server.csr',
                                                                                  'type': 'file'},
                                                                                { 'name': 'server.key',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/server/server.key',
                                                                                  'type': 'file'},
                                                                                { 'name': 'server.pem',
                                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/server/server.pem',
                                                                                  'type': 'file'}],
                                                                  'name': 'server',
                                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid/server',
                                                                  'type': 'dir'}],
                                                  'name': 'valid',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs/valid',
                                                  'type': 'dir'}],
                                  'name': 'certs',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/certs',
                                  'type': 'dir'},
                                { 'name': 'compat.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/compat.py',
                                  'type': 'file'},
                                { 'name': 'conftest.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/conftest.py',
                                  'type': 'file'},
                                { 'name': 'test_adapters.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/test_adapters.py',
                                  'type': 'file'},
                                { 'name': 'test_help.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/test_help.py',
                                  'type': 'file'},
                                { 'name': 'test_hooks.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/test_hooks.py',
                                  'type': 'file'},
                                { 'name': 'test_lowlevel.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/test_lowlevel.py',
                                  'type': 'file'},
                                { 'name': 'test_packages.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/test_packages.py',
                                  'type': 'file'},
                                { 'name': 'test_requests.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/test_requests.py',
                                  'type': 'file'},
                                { 'name': 'test_structures.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/test_structures.py',
                                  'type': 'file'},
                                { 'name': 'test_testserver.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/test_testserver.py',
                                  'type': 'file'},
                                { 'name': 'test_utils.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/test_utils.py',
                                  'type': 'file'},
                                { 'children': [ { 'name': '__init__.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/testserver/__init__.py',
                                                  'type': 'file'},
                                                { 'name': 'server.py',
                                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/testserver/server.py',
                                                  'type': 'file'}],
                                  'name': 'testserver',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/testserver',
                                  'type': 'dir'},
                                { 'name': 'utils.py',
                                  'path': '/tmp/tmpkl_8b4xv/repo/tests/utils.py',
                                  'type': 'file'}],
                  'name': 'tests',
                  'path': '/tmp/tmpkl_8b4xv/repo/tests',
                  'type': 'dir'},
                { 'name': 'tox.ini',
                  'path': '/tmp/tmpkl_8b4xv/repo/tox.ini',
                  'type': 'file'}],
  'name': 'repo',
  'path': '/tmp/tmpkl_8b4xv/repo',
  'type': 'dir'}
```
